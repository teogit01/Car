...
<div id="wrapper-content">
    ...
    <div class="d-flex" style="justify-content: flex-end;margin: 5px;">
            <div>
                <a href="{{route('service.add')}}"><button class="btn btn-primary" style="width: 90px;color: black;"> Thêm</button>
                </a>
            </div>
    </div>
    <br>
...
@section('js')    
    <script>        
        ...
        // Update
        function edit(id) {
            window.location= path+'admin/service/'+id;
        }
    </script>
@endsection
