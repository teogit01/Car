<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('src/admin/plugins/fontawesome-free/css/all.min.css')}}">
  <!-- Ionicons -->
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{asset('src/admin/plugins/jqvmap/jqvmap.min.css')}}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('src/admin/dist/css/adminlte.min.css')}}">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{asset('src/admin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}">
  <!-- Daterange picker -->
