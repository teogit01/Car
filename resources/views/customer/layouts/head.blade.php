 ...
 <link rel="stylesheet" href="{{asset('src/customer/css/flaticon.css')}}">
 <link rel="stylesheet" href="{{asset('src/customer/css/animate.min.css')}}">
 <link rel="stylesheet" href="{{asset('src/customer/css/magnific-popup.css')}}">
 <link rel="stylesheet" href="{{asset('src/customer/css/fontawesome-all.min.css')}}">
 <link rel="stylesheet" href="{{asset('src/customer/css/themify-icons.css')}}">
